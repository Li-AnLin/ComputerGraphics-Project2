...
namespace OpenMesh_EX {
	...
	private: System::Windows::Forms::ToolStripMenuItem^  weightTypeToolStripMenuItem;
	private: System::Windows::Forms::ToolStripMenuItem^  barycentricToolStripMenuItem;
	private: System::Windows::Forms::ToolStripMenuItem^  harmonicToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->weightTypeToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			this->barycentricToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			this->harmonicToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->saveMeshDialog = (gcnew System::Windows::Forms::SaveFileDialog());
			this->loadMeshToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			this->openMeshDialog = (gcnew System::Windows::Forms::OpenFileDialog());
			...
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {
				this->fileToolStripMenuItem,
					this->boundaryTypeToolStripMenuItem, this->weightTypeToolStripMenuItem
			});
			...
			this->fileToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(5) {
				this->loadModelToolStripMenuItem,
					this->saveModelToolStripMenuItem, this->loadTextureToolStripMenuItem, this->saveMeshToolStripMenuItem, this->loadMeshToolStripMenuItem
			});
			...
			this->loadTextureToolStripMenuItem->Size = System::Drawing::Size(152, 22);
			...
			this->saveMeshToolStripMenuItem->Size = System::Drawing::Size(152, 22);
			this->saveMeshToolStripMenuItem->Text = L"Save Mesh";
			this->saveMeshToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::saveMeshToolStripMenuItem_Click);
			// 
			...
			// 
			// weightTypeToolStripMenuItem
			// 
			this->weightTypeToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(2) {
				this->barycentricToolStripMenuItem,
					this->harmonicToolStripMenuItem
			});
			this->weightTypeToolStripMenuItem->Name = L"weightTypeToolStripMenuItem";
			this->weightTypeToolStripMenuItem->Size = System::Drawing::Size(88, 20);
			this->weightTypeToolStripMenuItem->Text = L"WeightType";
			// 
			// barycentricToolStripMenuItem
			// 
			this->barycentricToolStripMenuItem->Name = L"barycentricToolStripMenuItem";
			this->barycentricToolStripMenuItem->Size = System::Drawing::Size(136, 22);
			this->barycentricToolStripMenuItem->Text = L"barycentric";
			this->barycentricToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::barycentricToolStripMenuItem_Click);
			// 
			// harmonicToolStripMenuItem
			// 
			this->harmonicToolStripMenuItem->Name = L"harmonicToolStripMenuItem";
			this->harmonicToolStripMenuItem->Size = System::Drawing::Size(136, 22);
			this->harmonicToolStripMenuItem->Text = L"harmonic";
			this->harmonicToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::harmonicToolStripMenuItem_Click);
			// 
			// openModelDialog
			// 
			...
			// saveMeshDialog
			// 
			this->saveMeshDialog->DefaultExt = L"mesh";
			this->saveMeshDialog->FileOk += gcnew System::ComponentModel::CancelEventHandler(this, &MyForm::saveMeshDialog_FileOk);
			// 
			// openMeshDialog
			// 
			this->openMeshDialog->DefaultExt = L"mesh";
			this->openMeshDialog->FileOk += gcnew System::ComponentModel::CancelEventHandler(this, &MyForm::openMeshDialog_FileOk);
			// 
			// loadMeshToolStripMenuItem
			// 
			this->loadMeshToolStripMenuItem->Name = L"loadMeshToolStripMenuItem";
			this->loadMeshToolStripMenuItem->Size = System::Drawing::Size(152, 22);
			this->loadMeshToolStripMenuItem->Text = L"Load Mesh";
			this->loadMeshToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::loadMeshToolStripMenuItem_Click);
			// 
			// MyForm
			// 
...
#pragma endregion
	...
	{
		openMeshDialog->Filter = "Mesh(*.mesh)|*mesh";
		openMeshDialog->Multiselect = false;
		openMeshDialog->ShowDialog();
	}
	private: System::Void openMeshDialog_FileOk(System::Object^  sender, System::ComponentModel::CancelEventArgs^  e)
	{
		std::string filename;
		MarshalString(openMeshDialog->FileName, filename);
	...
	{
		openTextureDialog->Filter = "PNG Texture(*.png)|*png|JPG Texture(*.jpg)|*jpg";
		openTextureDialog->FilterIndex = 2;
	...
	private: System::Void openTextureDialog_FileOk(System::Object^  sender, System::ComponentModel::CancelEventArgs^  e)
	{
		...
		hkoglPanelControl1->Invalidate();
		mesh->LoadTexture(strdup(filename.c_str()), 1);
	}
	...
	{
		saveMeshDialog->Filter = "Mesh(*.mesh)|*mesh";
		saveMeshDialog->ShowDialog();
	}
	private: System::Void saveMeshDialog_FileOk(System::Object^  sender, System::ComponentModel::CancelEventArgs^  e)
	{
		std::string filename;
		MarshalString(saveMeshDialog->FileName, filename);
	...
	private: System::Void barycentricToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
		if (mesh != NULL)
		{
			mesh->Weight_type = 0;
			hkoglPanelControl2->Invalidate();
	...
	private: System::Void harmonicToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
		if (mesh != NULL)
		{
			mesh->Weight_type = 1;
			hkoglPanelControl2->Invalidate();
